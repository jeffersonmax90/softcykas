...
public class Zona_inicio_cuerpo_registrado extends Zona_inicio_cuerpo_registrado_ventanas {
	/*
	...
	*/
	...
	public Zona_inicio_cuerpo_registrado(){
		...
		videos_de_suscripciones_layout.addComponent(vds);
		videos_relacionados_layout.addComponent(vr);
	}
}